...
function DesignerContent() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gray-900">
      {/* Header */}
      <header className="bg-white dark:bg-gray-950 text-gray-900 dark:text-white p-4 flex justify-between items-center shadow-md border-b border-gray-200 dark:border-gray-800">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Spartan Design</h1>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar - Tools */}
        <aside className="w-72 bg-gray-100 dark:bg-gray-800 px-6 py-5 overflow-y-auto border-r border-gray-200 dark:border-gray-700 shadow-sm">
          <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Tools</h2>
          <div className="space-y-2">
            <button
              onClick={handleAddRectangle}
              className="w-full px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition text-gray-900 dark:text-gray-100"
            >
              + Rectangle
            </button>
            <button
            ...
            <button
              disabled
              className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg cursor-not-allowed text-gray-500"
            >
              + Custom Path (Coming Soon)
            </button>
          </div>

          <h2 className="text-lg font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">Metal Type</h2>
          <div className="space-y-2">
            <label className="flex items-center p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition bg-white dark:bg-gray-700">
              <input
                type="radio"
                name="metalType"
                value="Mild Steel"
              ...
              />
              <span className="font-medium text-gray-900 dark:text-gray-100">Mild Steel</span>
            </label>
            <label className="flex items-center p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition bg-white dark:bg-gray-700">
              <input
                type="radio"
                ...
                className="mr-3 w-4 h-4"
              />
              <span className="font-medium text-gray-900 dark:text-gray-100">Stainless Steel</span>
            </label>
            <label className="flex items-center p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition bg-white dark:bg-gray-700">
              <input
                type="radio"
                ...
                className="mr-3 w-4 h-4"
              />
              <span className="font-medium text-gray-900 dark:text-gray-100">Aluminium</span>
            </label>
          </div>

          <h2 className="text-lg font-semibold mt-6 mb-4 text-gray-900 dark:text-gray-100">Thickness</h2>
          <select
          ...
          <h2 className="text-lg font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">Units</h2>
          ...
          <div className="space-y-2">
            <div>
              <label className="block text-sm mb-1 font-medium text-gray-900 dark:text-gray-100">
            ...
            {selectedShape?.type !== 'circle' && (
              <div>
                <label className="block text-sm mb-1 font-medium text-gray-900 dark:text-gray-100">Length ({displayUnit})</label>
                <input
                  type="number"
                  value={defaultLength}
          ...
          {selectedShape && (
            <>
              <h2 className="text-lg font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">Shape Actions</h2>
              <div className="space-y-2">
                <button
                  onClick={handleDeleteShape}
                  className="w-full px-4 py-2 bg-rose-500 hover:bg-rose-600 text-white rounded-lg transition"
                >
                  Delete Shape
                </button>
              </div>
              ...
              <div className="space-y-3 p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-300 dark:border-gray-600">
                <div>
                  <label className="block text-xs mb-1 font-medium text-gray-900 dark:text-gray-100">Hole Type</label>
                  <div className="flex gap-2">
                    <button
                      onClick={() => handleAddHole('circle')}
                      className="flex-1 px-3 py-2 bg-secondary-400 hover:bg-secondary-500 dark:bg-secondary-500 dark:hover:bg-secondary-600 text-white rounded-lg text-sm transition"
                    >
                      + Circle
                    </button>
                    <button
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm"
                      step={displayUnit === 'm' ? '0.001' : displayUnit === 'cm' ? '0.01' : '0.1'}
                      min={displayUnit === 'm' ? '0.001' : displayUnit === 'cm' ? '0.01' : '0.1'}
                    />
                  </div>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    {selectedShape.holes.map((hole, index) => (
                      <div key={hole.id} className="p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-300 dark:border-gray-600">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <button
                            ...
                            className="px-2 py-1 bg-rose-500 hover:bg-rose-600 text-white rounded-lg text-xs transition"
                          >
                            Delete
                          </button>
                        </div>
                        ...
                        {editingHoleId === hole.id ? (
                          <div className="space-y-2">
                            {hole.type === 'circle' ? (
                              <div>
                                <label className="block text-xs mb-1 text-gray-900 dark:text-gray-100">Diameter ({displayUnit})</label>
                                <input
                                  type="number"
                              ...
                              <>
                                <div>
                                  <label className="block text-xs mb-1 text-gray-900 dark:text-gray-100">Width ({displayUnit})</label>
                                  <input
                                    type="number"
                                ...
                                <div>
                                  <label className="block text-xs mb-1 text-gray-900 dark:text-gray-100">Height ({displayUnit})</label>
                                  <input
                                    type="number"
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <div>
                                <label className="block text-xs mb-1 text-gray-900 dark:text-gray-100">Position X ({displayUnit})</label>
                                <input
                                  type="number"
                              ...
                              <div>
                                <label className="block text-xs mb-1 text-gray-900 dark:text-gray-100">Position Y ({displayUnit})</label>
                                <input
                                  type="number"
                            ...
                            <button
                              ...
                              className="w-full px-3 py-1 bg-accent-500 hover:bg-accent-600 dark:bg-accent-600 dark:hover:bg-accent-700 text-white rounded-lg text-sm transition"
                            >
                              Done Editing
                            </button>
                          </div>
                          ...
                          <div>
                            ...
                            <button
                              ...
                              className="mt-2 w-full px-3 py-1 bg-primary-500 hover:bg-primary-600 dark:bg-primary-600 dark:hover:bg-primary-700 text-white rounded-lg text-sm transition"
                            >
                              Edit
                            </button>
                          </div>
